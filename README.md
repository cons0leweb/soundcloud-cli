...
/ ПОИСК   m МИКСЫ   l ЛАЙКИ   h ИСТОРИЯ
 ...
 /  Персональные миксы
──────────────────────────────────────────────────────────────────────
ПЕРСОНАЛЬНЫЕ МИКСЫ · 20
 1 ◆ Your Mix 1 · SoundCloud                                МИКС  ↵
 2 ◆ Your Mix 2 · SoundCloud                                МИКС  ↵
 3 ◆ Your Mix 3 · SoundCloud                                МИКС  ↵

──────────────────────────────────────────────────────────────────────
▶ ИГРАЕТ  Керт, я тебя люблю · okone
━━━━━━────────────────────────  0:42 / 3:24            ОЧЕРЕДЬ 1/30
...
```bash
curl -LO https://github.com/cons0leweb/soundcloud-cli/releases/download/v0.2.1/soundcloud_0.2.1_Linux_x86_64.tar.gz
tar -xzf soundcloud_0.2.1_Linux_x86_64.tar.gz
